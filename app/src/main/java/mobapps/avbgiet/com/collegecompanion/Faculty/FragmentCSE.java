...
public class FragmentCSE extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    view = inflater.inflate(R.layout.fragment_cse, container, false);
    return view;
  }
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    databaseReference = FirebaseDatabase.getInstance().getReference().child("Database").child("Faculty").child("CSE");
    ...
    contactList = (RecyclerView) view.findViewById(R.id.contactlistCSE);
